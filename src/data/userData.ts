  ...
  experience: [
    {
      ...
      endDate: "Presente",
      description:
        "Desarrollo full stack en asignación para cliente internacional vía Experis. Implementación de funcionalidades en .NET y React, modelado y consultas en PostgreSQL, y despliegues en Azure. Trabajo remoto desde Trujillo en equipo ágil.",
